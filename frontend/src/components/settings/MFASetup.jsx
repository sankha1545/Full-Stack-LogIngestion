...
export default function MFASetup({ onClose }) {
  ...
  async function refreshProfile() {
    ...
    // Update localStorage so AuthContext reflects it
  ...
  return (
    <div className="w-full max-w-lg p-6 space-y-6 border rounded-2xl bg-white/5 border-white/10 backdrop-blur">
